...
python sweep.py --nu 2 1 -t1 -1 -1 1 -t2 -0.0 -0.0 1 -U0 1 10 51 -U1 0 10 51 -H 0.6 -n 33 --thres 1e-10
# python sweep.py --nu 2 1 -t1 -1 -1 1 -t2 -0 -0.2 11 -U0 1 10 10 -U1 0 0 1 -H 0.6 -n 33 --thres 1e-10
